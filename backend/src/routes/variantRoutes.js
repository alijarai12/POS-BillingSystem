...
router.post('/products/:productId/variants', uploader.single("image"), variantController.createVariant); // POST request to add a variant to a specific product
router.put('/variants/:id',uploader.single("image"), variantController.updateVariantById); // PUT request to update a variant by ID
